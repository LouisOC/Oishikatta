    ...
    <form novalidate action="./?path=admin&action=processUpdate" method="post" class="d-flex justify-content-center">
        ...
        <section class="my-2">
            ...
            <div class="my-2 col-lg-12 col-md-8">
                ...
                <input minlength="2" required name="nom" id="inputNom" type="text" class="form-control" value="<?= $kimonos->getTitre() ?>">
            </div>
            <hr>
            ...
            <div class="my-2 col-lg-12 col-md-8">
                ...
                <input minlength="2" required name="nom" id="inputNom" type="text" class="form-control" value="<?= $kimonos->getImageKimono() ?>">
            </div>
            <hr>

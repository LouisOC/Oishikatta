...
<div class="container mt-5">
    <form novalidate action="./?path=plat&action=updatePlat" method="post" class="d-flex justify-content-center">
        ...
        <section class="my-2">
            <h1 class="text-center mb-5">Formulaire de modification d'un plat</h1>
            ...
            <div class="my-2 col-lg-12 col-md-8">
                ...
                <input required type="number" name="id_categorie" min="1" step="1" max="3" class="form-control" value="<?= $plats->getIdCategorie() ?>" />
            </div>

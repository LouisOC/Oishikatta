...
<div class="container mt-5">
    <form action="./?path=horairesouverture&action=processUpdate" method="post" class="d-flex justify-content-center">
        <input type="hidden" name="id" value="<?= $jours->getIdHorairesOuverture() ?>">
        ...
        <section class="my-2">
            ...
            <div class="mb-3">
                ...
                <select name="heure_Ouverture" required class="form-control">
            ...
            <div class="mb-3">
                ...
                <select name="heure_Fermeture" required class="form-control">

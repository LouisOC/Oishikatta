...
<div class="container mt-5">
    <form action="./?path=reservation&action=processReservation" method="post" class="d-flex justify-content-center">
        <section class="my-2">
            <h1 class="text-center mb-5">Formulaire d'ajout d'une réservation</h1>
